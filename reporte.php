...
if (isset($_GET['fechaDesde']) and isset($_GET['fechaHasta'])) {
    ...
    $getfecDesde= date_create('now')->format('d-m-Y');
    $getfecHasta= date_create('now')->format('d-m-Y');
}
...
$rs = $dbCliente->conReporteCuentaCliente($getCliente,$getfecDesde,$getfecHasta);
$rsCliente = $dbCliente->conClienteNombre($getCliente);
...
<form action="" id="formulario" method="get">
    <div id="cont1" class="contDate">
        ...
        <div id="btn1" class="btnbuscar" onclick="cargar_Pagina();"></div>
    </div>
</form>
<div class="menu_export">
    ...
    <a id="hyp_mail" class="email" onclick="mail();" ></a>
</div>
...
function mail() {
    ...
    var clienteId = <?php echo $getCliente; ?>;
    var fechaDesde =<?php echo $getfecDesde; ?>;
    var fechaHasta =<?php echo $getfecHasta; ?>;
