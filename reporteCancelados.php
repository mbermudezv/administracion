...
try {
    ...
    if (isset($_GET['fechaDesde']) and isset($_GET['fechaHasta'])) {
        ...
        $db = new Select();
        $rs = $db->conReporteCuentasCanceladas($getfecDesde,$getfecHasta);    
    }	
...
<div class="menu_export">
    ...
    <a id="hyp_excel" class="excel" href="reporte_exportarCancelados.php?fechaDesde=<?php echo $getfecDesde;?>&fechaHasta=<?php echo $getfecHasta;?>&t=1"></a>
    <a id="hyp_word" class="word" href="reporte_exportarCancelados.php?fechaDesde=<?php echo $getfecDesde;?>&fechaHasta=<?php echo $getfecHasta;?>&t=2"></a>
</div>
<div id="enc1" class="encabezado">
    <div id="log1" class="logo"></div>
    <div id="tit1" class="titulo">Informe de ingresos por almuerzos</div>
</div>
